...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors().configurationSource(corsConfigurationSource())
            ...
            .requestMatchers(new AntPathRequestMatcher("/api/v1/cinema/movies/v3/**")).permitAll()
            .requestMatchers(new AntPathRequestMatcher("/api/v1/cinema/movies")).permitAll()
            .requestMatchers(new AntPathRequestMatcher("/api/v1/cinema/**")).authenticated()
            .requestMatchers(new AntPathRequestMatcher("/api/v1/cinema/movies/info")).authenticated()
